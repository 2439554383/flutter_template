...
mixin _$TestModel {
 ...
 String get title; void Function() get method;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TestModel&&(identical(other.title, title) || other.title == title)&&(identical(other.method, method) || other.method == method));
}


@override
int get hashCode => Object.hash(runtimeType,title,method);

@override
String toString() {
  return 'TestModel(title: $title, method: $method)';
}
...
@useResult
$Res call({
 String title, void Function() method
});
...
/// Create a copy of TestModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? method = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  void Function() method)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TestModel() when $default != null:
return $default(_that.title,_that.method);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  void Function() method)  $default,) {final _that = this;
switch (_that) {
case _TestModel():
return $default(_that.title,_that.method);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  void Function() method)?  $default,) {final _that = this;
switch (_that) {
case _TestModel() when $default != null:
return $default(_that.title,_that.method);case _:
  return null;
...
class _TestModel extends TestModel {
  const _TestModel({required this.title, required this.method}): super._();
  

@override final  String title;
@override final  void Function() method;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TestModel&&(identical(other.title, title) || other.title == title)&&(identical(other.method, method) || other.method == method));
}
...
/// Create a copy of TestModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? method = null,}) {
