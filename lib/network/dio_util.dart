...
class HttpUtil {
  ...
  setTrsToken(String trsToken, String accountNo) {
    dio.options.headers['trs-Token'] = trsToken;
    dio.options.headers['trs-Account'] = accountNo;
  }

  cleanTrsToken() {
    dio.options.headers.remove('trs-Token');
    dio.options.headers.remove('trs-Account');
  }
  ...
  //     var response = await dio.post(Api.uploadFile, data: formData);
  //     return ApiResult.success(response);
  //   } on DioException catch (e) {
  //     return ApiResult.failure(e);
  //   }
